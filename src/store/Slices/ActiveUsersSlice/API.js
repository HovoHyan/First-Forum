...
export const getActiveUsers = createAsyncThunk(
  "activeUsersData/getActiveUsers",
  async () => {
...
export const deleteActiveUser = createAsyncThunk(
  "activeUsersData/deleteActiveUser",
  async (id) => {
...
export const changeActiveAvatar = createAsyncThunk(
  "activeUsersData/changeActiveAvatar",
